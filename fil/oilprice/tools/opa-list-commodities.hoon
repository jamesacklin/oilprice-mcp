::  opa-list-commodities: list all available commodities and their API codes
::
/-  mcp, spider
/+  io=strandio
=,  strand-fail=strand-fail:strand:spider
^-  tool:mcp
:*  'opa-list-commodities'
    'List all available commodities and their API codes.'
    ~
    ~
::
    ...
    ::  GET /v1/commodities
    ::
    =/  url=tape  "https://api.oilpriceapi.com/v1/commodities"
    ::  load API key
    ::
