::  opa-get-rig-counts: fetch latest oil and gas rig count data
::
/-  mcp, spider
/+  io=strandio
...
^-  tool:mcp
:*  'opa-get-rig-counts'
    'Get the latest oil and gas rig counts.'
    ~
    ~
::
    ...
    ::
    =/  url=tape  "https://api.oilpriceapi.com/v1/rig-counts/latest"
    ::  load API key
    ::
